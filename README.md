...
* Improve workflow and communication between designers and developers. Most development is impossible 
...
// Keywords: pattern, wireframe, mockup, demo, prototype, blueprint, bootstrap, scheme, 

TODO:
-----
complete these descriptions for...
* Sub-projects and backward compatibility (todo... but for now, suffice it to say that we will incorporate some other open source works into this project with full attribution, but in most cases we will break from the original repos in order to maintain a high level of consistency with code structure and patterns.)
* Contributing
...
Here are some write ups on templating and the various solutions that exist, along with advantages and disadvantages.
...
If this project doesn't work for you, here are some other projects that might offer what you need.
...
* [diazo](http://docs.diazo.org/en/latest/index.html)

Ruby Templates
--------------
* [tilt](https://github.com/rtomayko/tilt)
* [statis](http://stasis.me/#supported_markup_languages) - Static sites made powerful. Uses [tilt](https://github.com/rtomayko/tilt)
* 

Static Site Generators
----------------------
* [frank](https://github.com/blahed/frank) - Frank lets you build static sites using your favorite libs
* [jekyll](https://github.com/mojombo/jekyll) - Jekyll is a blog-aware, static site generator in Ruby
* [hyde](http://ringce.com/hyde) - Static website generator powered by Python & Django
...
* [dynamicmatic](https://github.com/nex3/dynamicmatic) - Dynamic StaticMatic pages with Sinatra
* [staticmatic](http://staticmatic.rubyforge.org/how_to_use.html) - Static websites using HAML
* [hakyll](http://jaspervdj.be/hakyll/tutorial.html) - Hakyll is a Haskell library meant for creating small-to-medium sized static websites
* 
